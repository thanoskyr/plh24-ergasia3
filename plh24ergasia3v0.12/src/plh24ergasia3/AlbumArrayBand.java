...
public class AlbumArrayBand extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        albumQuery = java.beans.Beans.isDesignTime() ? null : radioDBv2PUEntityManager.createQuery("SELECT a FROM Album a WHERE a.artistartistId is null");
        ...
        setTitle("ΑΛΜΠΟΥΜ ΣΥΓΚΡΟΤΗΜΑΤΩΝ");
        ...
        org.jdesktop.swingbinding.JTableBinding.ColumnBinding columnBinding = jTableBinding.addColumnBinding(org.jdesktop.beansbinding.ELProperty.create("${musicGroupmusicGroupId.name}"));
        ...
        columnBinding.setColumnName("Αριθμός Δισκου");
        ...
        jButton4.setToolTipText("Εξοδος");
        ...
        jLabel1.setText("Πίνακας Αλμπουμ Συγκροτημάτων");
